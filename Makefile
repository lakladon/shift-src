...
kernel.bin: kernel.c iozh.c serialka.c ekran.c klava.c stroki.c
	...
	ld -m elf_i386 -Ttext 0x1000 --oformat binary kernel.o iozh.o serialka.o ekran.o klava.o stroki.o -o kernel.bin
	rm -f kernel.o iozh.o serialka.o ekran.o klava.o stroki.o
...
clean:
	rm -f boot.bin kernel.bin os.bin k.o kernel.o iozh.o serialka.o ekran.o klava.o stroki.o